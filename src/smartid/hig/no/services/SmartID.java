...
/**
 * A class for encapsulating the whole SmartID contents: the files, and the
 * encryption keys. Can be intialized (a) almost empty, (b) from the SmartID
 * object (i.e. read in from the card), (c) form a ZIP file containg the data
 * groups.
 *
 *
 */
public class SmartID {
	...
	/**
	 * Uploads this SmartID to the card using the provided Personalization
	 * service.
	 *
